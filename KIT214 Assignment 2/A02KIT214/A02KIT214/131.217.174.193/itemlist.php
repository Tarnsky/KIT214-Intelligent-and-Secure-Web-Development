                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['itemsearch']))
                                    {
                                        ...
                                        if (is_numeric($itemsearch)) 
                                        {
                                            echo "400 Bad Request, Please search item name";
                                        }
                                        else 
                                        {
                                        ...
                                        $result = $mysqli->query($query);
                                            ...
                                            if($row_cnt = mysqli_num_rows($result) >= 1)
                                            {
                                                foreach($result as $row)
                                                {
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" value="https://<?=$row['IP_address']; ?>/itemlist.php" class="form-control">
                                                    </div>
                                                    <?php
                                                }
                                            }
                                            ...
                                            {
                                                    echo "404 Not Found, No Item Found";
                                            }
                                        }
                                    }
...
<itemlist>
  ...
  <title>Seller - John</title>
   ...
   <items>
      <itemid>2</itemid>
      <itemname>Grassclippings</itemname>
      <price>10</price>
   </items>
   <items>
      <itemid>3</itemid>
      <itemname>Black mail envelope</itemname>
      <price>15</price>
   </items>
   <items>
      <itemid>4</itemid>
            ...
            <th>
                <form action="itemlist.php" method="post">
                    <select name="selecteditem[]">
                        <option value="5">BakingSoda</option>
                        <option value="10">Grassclippings</option>
                        <option value="15">Black mail envelope</option>
                        <option value="15">Drangon</option>
                    </select>
    ...
    <?php

        {
            ...
            if((int)$result < (int)$selecteditem){
              die ("403 Forbidden: transaction failed please go back a page");
